...
export class HttpClient {
    ...
    async request(requestOptionsOrFactory, overrides) {
        ...
        try {
            ...
            this.handleRequestError(e, options, overrides);
        }
    }
    ...
    handleRequestError(error, requestOptions, overrides) {
        ...
        silent(() => {
            ...
            return (_a = this.opts.errorHandler) === null || _a === void 0 ? void 0 : _a.handleError(requestError, {
                errorCodesMapping: overrides === null || overrides === void 0 ? void 0 : overrides.errorCodesMapping,
                showError: overrides === null || overrides === void 0 ? void 0 : overrides.showError,
            });
        });
        throw requestError;
    }
