...
export function objectPromiseAll(target) {
    var _this = this;
    return Object.keys(target).reduce(function (acc, key) { return __awaiter(_this, void 0, void 0, function () {
        var obj, _a, _b;
        var _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_c[_b] = _d.sent(), _c)]))];
            }
        });
    }); }, Promise.resolve({}));
}
...
var dataCallback = function (data) { return data; };
export var buildSentryOptions = function (_a) {
    var dsn = _a.dsn, environment = _a.environment, release = _a.release, withDataCallback = _a.withDataCallback, tags = _a.tags;
    return {
        dsn: dsn,
        config: {
