...
export default function create(options) {
  ...
  const animationOptions = {
    transition: transitionDuration ? `transform ${transitionDuration}ms ${getMouseTransitionEasing(transitionEasing)}, filter ${transitionDuration}ms ${getMouseTransitionEasing(transitionEasing)}` : '',
    distance,
    angle,
    scale,
    blur,
